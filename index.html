      ...
      <div class="col-lg-3 col-md-6 p-lg-3 p-md-3 p-sm-3 pb-2">
        <div class="card" ">
          ...
          <div class="card-body">
            ...
            <a href="https://app-tasks-node.herokuapp.com/" class="btn btn-primary btn-lg btn-block heroku" ><img src="./assets/img/heroku_logo_icon_168126.svg" alt=""></a>
            <a href="https://github.com/EliasMoura2/app-tasks" class="btn btn-primary btn-lg btn-block github"><img src="./assets/img/logo_github_icon_160827.svg" alt=""></a>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 p-lg-3 p-md-3 p-sm-3 pb-2">
        <div class="card";">
          ...
          <div class="card-body">
            ...
            <a href="https://pokedex-vanillajs.herokuapp.com/" class="btn btn-primary btn-lg btn-block heroku" ><img src="./assets/img/heroku_logo_icon_168126.svg" alt=""></a>
            <a href="https://github.com/EliasMoura2/basicPokedex" class="btn btn-primary btn-lg btn-block github"><img src="./assets/img/logo_github_icon_160827.svg" alt=""></a>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 p-lg-3 p-md-3 p-sm-3 pb-2">
        <div class="card"">
          ...
          <div class="card-body">
            ...
            <a href="https://todo-basic-js-localstorage.herokuapp.com/" class="btn btn-primary btn-lg btn-block heroku" ><img src="./assets/img/heroku_logo_icon_168126.svg" alt=""></a>
            <a href="https://github.com/EliasMoura2/todoList-vanillaJS-LocalStorage" class="btn btn-primary btn-lg btn-block github"><img src="./assets/img/logo_github_icon_160827.svg" alt=""></a>
          </div>
        </div>
      </div>
    </div>
